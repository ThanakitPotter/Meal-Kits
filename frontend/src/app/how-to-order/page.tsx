...
export default function HowToOrderPage() {
  return (
    <div className="container mx-auto px-4 py-20 max-w-4xl">
      <h1 className="text-4xl font-extrabold text-center mb-12 text-[#333333]">วิธีการสั่งซื้อ (How to Order)</h1>
      <div className="space-y-12">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-3 text-[#333333]">1. เลือกเมนูที่คุณชื่นชอบ</h3>
            <p className="text-lg text-[#333333]/70 leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div className="md:text-right">
            <h3 className="text-2xl font-bold mb-3 text-[#333333]">2. เราจัดเตรียมวัตถุดิบสดใหม่</h3>
            <p className="text-lg text-[#333333]/70 leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div>
            <h3 className="text-2xl font-bold mb-3 text-[#333333]">3. จัดส่งถึงหน้าบ้านคุณ</h3>
            <p className="text-lg text-[#333333]/70 leading-relaxed">
