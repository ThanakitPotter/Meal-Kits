  ...
  return (
    <div className="container mx-auto px-4 py-20 max-w-4xl">
      ...
      <div className="bg-white text-[#333333] p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100">
        <h2 className="text-2xl font-bold text-[#E0A800] mb-4">จุดเริ่มต้นของ Meal Kits</h2>
        ...
        <p className="text-lg text-[#333333] leading-relaxed mb-6">
          จึงถือกำเนิดขึ้นเพื่อเป็นผู้ช่วยส่วนตัวในครัวของคุณ เรามีทีมเชฟที่คอยคิดค้นสูตรอาหารยอดฮิต คัดสรรวัตถุดิบที่สดใหม่ในปริมาณที่พอดีเป๊ะ 
        ...
        <ul className="list-disc list-inside text-lg text-[#333333] space-y-3">
