export default function ContactPage() {
  return (
    <div className="container mx-auto px-4 py-20 max-w-2xl">
      <h1 className="text-4xl font-extrabold text-center mb-12">ติดต่อเรา (Contact Us)</h1>
      ...
      <div className="bg-base-100 shadow-xl rounded-2xl p-8 border border-base-200">
        <form className="space-y-6">
          <div className="form-control">
            ...
            <input type="text" placeholder="ระบุชื่อของคุณ" className="input input-bordered w-full" />
          </div>
          ...
          <div className="form-control">
            ...
            <textarea className="textarea textarea-bordered h-32" placeholder="พิมพ์ข้อความที่คุณต้องการติดต่อ..."></textarea>
          </div>
        ...
        <div className="text-center space-y-2 text-base-content/70">
